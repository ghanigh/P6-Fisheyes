...
class Likes {
  constructor(photographerDataLikes) {
    ...
    this._toggleLike = document.querySelector(`#likes-${photographerDataLikes}`);
    // Trouve l'élément avec la classe 'countLikes-{photographerDataLikes}'
    this._countLikes = document.querySelector(`.countLikes-${photographerDataLikes}`);
  ...
  incrementTotalLikes() {
    ...
    this._totalCountLikes.setAttribute("aria-label", `Nombre de likes : ${totalLikes}`);
